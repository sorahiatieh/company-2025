...
(2, 0, 'بلاگ', 'Internal', 'blog', 0, 2, 1),
(3, 0, 'گالری تصاویر', 'Internal', 'gallery', 0, 3, 1),
(4, 0, 'پروژه ها', 'Internal', 'projects', 0, 4, 1),
(5, 0, 'درباره ما', 'Internal', 'about', 0, 5, 1),
(6, 0, 'تماس با ما', 'Internal', 'contact', 0, 6, 1);
...
('blog', 'بلاگ', 'اخبار شرکت کمپانی | اخبار مهم', 'اخبار مهم شرکت کمپانی', '', 'بلاگ، وبلاک', 'بلاگ، وبلاگ', 1, 'blog/', 1),
('show_blog', 'نمایش خبر', 'جزییات اخبار شرکت کمپانی | جزییات خبر کمپانیمهم اخبار کمپانی', 'نمایش خبر شرکت کمپانی', '', 'خبر', 'خبر', 1, '', 1),
('show_project', 'متن پروژه ها', 'جزییات پروژه های شرکت کمپانی | جزییات پروژه ها', 'جزییات پروژه', '', 'کلمات کلیدی پروژه ها', 'توضیحات پروژه ها', 1, '', 1),
('projects', 'پروژه ها', 'پروژه های شرکت کمپانی | پروژه کمپانی', 'پروژه های شرکت کمپانی', '', 'پروژه ها', 'پروژه ها', 1, 'projects/', 1),
('main', 'خانه', 'خانه | صفحه اصلی | کمپانی', 'صفحه اصلی', '', 'خانه، صفحه نخست، ', 'صفحه نخست', 1, 'index.php', 1),
('search', 'جستجو', 'search', 'search', 'search', 'search', 'search', 0, '', 1);
